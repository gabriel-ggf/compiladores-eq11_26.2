...
MSVC — assim o time usa o mesmo ambiente (Flex/Bison/gcc/CMake via apt)
em qualquer sistema operacional, evitando divergências de build entre
Windows/Linux/macOS.
 * Instalar o WSL (PowerShell como administrador):
   wsl --install

   (por padrão instala Ubuntu; reinicie a máquina se for pedido)
 * Abrir o terminal Ubuntu/WSL e seguir os mesmos passos do Ubuntu/Debian
   acima (sudo apt install build-essential cmake flex bison) e o
   restante deste guia normalmente dentro do WSL.
 * O código do repositório pode continuar em C:\... e ser acessado de
...
|---|---|---|
| P1 | até 23/09/2026, 23h59 — link | 30/09/2026 (equipes 9 a 16, 2ª parte) |
| P2 | até 04/11/2026, 23h59 — link | 09/11/2026 (equipes 16 a 9, 1ª parte) |
 ...
 * Entrega final — repositório acessível 15 dias antes da entrevista
   ...
   docs/decisoes-tecnicas.md e
   docs/problemas-solucoes.md).
